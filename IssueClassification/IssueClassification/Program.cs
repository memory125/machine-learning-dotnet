...
namespace IssueClassification
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            _trainingDataView = _mlContext.Data.LoadFromTextFile<Issue>(_trainDataPath, hasHeader: true);
        ...
        public static IEstimator<ITransformer> BuildAndTrainModel(IDataView trainingDataView, IEstimator<ITransformer> pipeline)
        {
            ...
            _predEngine = _trainedModel.CreatePredictionEngine<Issue, IssuePrediction>(_mlContext);
        ...
        {
            var testDataView = _mlContext.Data.LoadFromTextFile<Issue>(_testDataPath, hasHeader: true);
        ...
        private static void PredictIssue()
        {
            ...
            Issue singleIssue = new Issue() { Title = "Entity Framework crashes", Description = "When connecting to the database, EF is crashing" };
            _predEngine = loadedModel.CreatePredictionEngine<Issue, IssuePrediction>(_mlContext);
